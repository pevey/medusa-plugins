...
const addressSchema = v.object({
	...
	address_1: optional(), address_2: optional(),
	city: optional(), province: optional(),
	postal_code: optional(),
	country_code: v.pipe(v.string(), v.nonEmpty('Select a country')),
	phone: optional(), company: optional(),
	billing_first_name: optional(), billing_last_name: optional(),
	billing_address_1: optional(), billing_address_2: optional(),
	billing_city: optional(), billing_province: optional(),
	billing_postal_code: optional(),
	billing_country_code: optional(),
	billing_phone: optional(), billing_company: optional()
})
