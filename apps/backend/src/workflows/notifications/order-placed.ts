...
const prepareOrderPlacedNotificationStep = createStep('prepare-order-placed-notification', async (id: string, { container }) => {
...
export const sendOrderPlacedNotificationWorkflow = createWorkflow('send-order-placed-notification', (id: string) => {
