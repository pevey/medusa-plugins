...
const prepareShipmentCreatedNotificationStep = createStep('prepare-shipment-created-notification', async (id: string, { container }) => {
	...
	const label = ((fulfillment as AnyRecord).labels ?? [])[0] as AnyRecord | undefined
...
export const sendShipmentCreatedNotificationWorkflow = createWorkflow('send-shipment-created-notification', (id: string) => {
