...
const prepareOrderNoteNotificationStep = createStep('prepare-order-note-notification', async (id: string, { container }) => {
...
export const orderNoteNotificationWorkflow = createWorkflow('order-note-notification', (id: string) => {
