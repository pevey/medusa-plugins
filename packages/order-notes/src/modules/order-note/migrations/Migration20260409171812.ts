...
export class Migration20260409171812 extends Migration {
	override async up(): Promise<void> {
		this.addSql(
			`create table if not exists "order_note" ("id" text not null, "order_id" text not null, "user_id" text not null, "note" text not null, "sent" boolean not null default false, "metadata" jsonb null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "order_note_pkey" primary key ("id"));`
		)
