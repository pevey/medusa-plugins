...
const identifyActorStep = createStep('identify-actor-step', async (input: IdentifyActorInput, { container }) => {
...
export const identifyActorWorkflow = createWorkflow('identify-actor-workflow', function (input: IdentifyActorInput) {
