...
export const guardAndCollectStep = createStep(
	'guard-and-collect-promotion-step',
...
export const deleteAffiliatePromotionWorkflow = createWorkflow(
	deleteAffiliatePromotionWorkflowId,
