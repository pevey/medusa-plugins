...
import {
	AffiliatePromotionRefInput,
	verifyAffiliateOwnsPromotionStep
} from './retire-affiliate-promotion'

export const reactivateAffiliatePromotionWorkflowId = 'reactivate-affiliate-promotion'

export const reactivateAffiliatePromotionWorkflow = createWorkflow(
	reactivateAffiliatePromotionWorkflowId,
