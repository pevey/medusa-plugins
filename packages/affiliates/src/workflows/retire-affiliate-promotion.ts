...
export const verifyAffiliateOwnsPromotionStep = createStep(
	'verify-affiliate-owns-promotion-step',
	async (input: AffiliatePromotionRefInput, { container }) => {
...
export const retireAffiliatePromotionWorkflow = createWorkflow(
	retireAffiliatePromotionWorkflowId,
	(input: AffiliatePromotionRefInput) => {
