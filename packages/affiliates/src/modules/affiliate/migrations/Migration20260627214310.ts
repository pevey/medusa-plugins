...
export class Migration20260627214310 extends Migration {
	override async up(): Promise<void> {
		this.addSql(`alter table if exists "affiliate_attribution" drop constraint if exists "affiliate_attribution_order_id_unique";`)
		this.addSql(
		...
		this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_affiliate_address_affiliate_id" ON "affiliate_address" ("affiliate_id") WHERE deleted_at IS NULL;`)
		this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_affiliate_address_deleted_at" ON "affiliate_address" ("deleted_at") WHERE deleted_at IS NULL;`)
		...
		this.addSql(`CREATE INDEX IF NOT EXISTS "IDX_affiliate_attribution_deleted_at" ON "affiliate_attribution" ("deleted_at") WHERE deleted_at IS NULL;`)
		this.addSql(
	...
	override async down(): Promise<void> {
		this.addSql(`alter table if exists "affiliate_address" drop constraint if exists "affiliate_address_affiliate_id_foreign";`)
