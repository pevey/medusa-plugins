...
import { StockLocationForVeeqoWarehouseInput, VeeqoWarehouseDTO, VeeqoWarehouseInput } from '../modules/veeqo/types'

const mapStockLocationToVeeqoWarehouseInput = (stock_location: StockLocationForVeeqoWarehouseInput): VeeqoWarehouseInput => {
...
export const getStockLocationDetailsStep = createStep('get-stock-location-details-step', async (stock_location_id: string, { container }) => {
	...
	if (!stockLocation) {
		throw new MedusaError(MedusaError.Types.NOT_FOUND, `Stock location with id ${stock_location_id} not found`)
	}
...
export const fetchWarehouseFromVeeqoStep = createStep('fetch-warehouse-from-veeqo-step', async (stock_location_id: string, { container }) => {
	const query = container.resolve('query')
	const {
	...
	if (!veeqoWarehouseId) {
		throw new MedusaError(MedusaError.Types.NOT_FOUND, `No linked Veeqo warehouse found for stock location ${stock_location_id}`)
	}
...
export const getVeeqoWarehouseWorkflow = createWorkflow('get-veeqo-warehouse-workflow', (stock_location_id: string) => {
...
export const addWarehouseToVeeqoStep = createStep('add-warehouse-to-veeqo-step', async (stock_location: StockLocationForVeeqoWarehouseInput, { container }) => {
...
export const addWarehouseToVeeqoWorkflow = createWorkflow('add-warehouse-to-veeqo-workflow', (stock_location_id: string) => {
...
export const updateWarehouseInVeeqoStep = createStep(
	...
	async (stock_location: StockLocationForVeeqoWarehouseInput, { container }) => {
		...
		if (!veeqoWarehouseId) {
			throw new MedusaError(MedusaError.Types.NOT_FOUND, `No linked Veeqo warehouse found for stock location ${stock_location.id}`)
		}
		const veeqoWarehouseInput = mapStockLocationToVeeqoWarehouseInput(stock_location)
		const veeqoService: VeeqoService = container.resolve('veeqo')
		const veeqoWarehouse = await veeqoService.updateWarehouse(veeqoWarehouseId, veeqoWarehouseInput)
		return new StepResponse(veeqoWarehouse)
	}
)

export const updateWarehouseInVeeqoWorkflow = createWorkflow('update-warehouse-in-veeqo-workflow', (stock_location_id: string) => {
	const stockLocation = getStockLocationDetailsStep(stock_location_id)
...
export const syncWarehouseToVeeqoWorkflow = createWorkflow('sync-warehouse-to-veeqo-workflow', (stock_location_id: string) => {
	const stockLocation = getStockLocationDetailsStep(stock_location_id)
...
export const findAndDeleteWarehouseFromVeeqoStep = createStep('find-and-delete-warehouse-from-veeqo-step', async (stock_location_id: string, { container }) => {
	const veeqoService: VeeqoService = container.resolve('veeqo')
	await veeqoService.deleteWarehouse(stock_location_id)
	return new StepResponse(void 0)
})

export const deleteWarehouseFromVeeqoWorkflow = createWorkflow('delete-warehouse-from-veeqo-workflow', (stock_location_id: string) => {
