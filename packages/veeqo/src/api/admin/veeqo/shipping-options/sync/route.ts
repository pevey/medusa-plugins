...
import { syncDeliveryMethodToVeeqoWorkflow } from '../../../../../workflows/delivery-method'
import { AdminSyncShippingOptionsToVeeqoType } from '../../../../validators'

// one-way sync of shipping options from medusa to veeqo
export const POST = async (req: AuthenticatedMedusaRequest<AdminSyncShippingOptionsToVeeqoType>, res: MedusaResponse) => {
