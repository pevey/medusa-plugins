...
export class Migration20260626062829 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "complaint_document" add constraint "complaint_document_complaint_id_foreign" foreign key ("complaint_id") references "complaint" ("id") on update cascade;`);
  }
