...
import { useUpdateWebhookTrigger } from '../hooks/webhooks'
...
export const EditWebhookTriggerDrawer = ({ trigger, open, setOpen }: Props) => {
	const { mutate: updateTrigger, isPending } = useUpdateWebhookTrigger(trigger.id)
