...
export class Migration20260409183947 extends Migration {
	override async up(): Promise<void> {
		...
		this.addSql(
			`alter table if exists "review_activity" add constraint "review_activity_review_id_foreign" foreign key ("review_id") references "review" ("id") on update cascade on delete cascade;`
		)
	}
