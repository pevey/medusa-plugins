...
export const GET = async (req: AuthenticatedMedusaRequest<AdminGetReviewsType>, res: MedusaResponse) => {
...
export const DELETE = async (req: AuthenticatedMedusaRequest<AdminDeleteReviewsType>, res: MedusaResponse) => {
