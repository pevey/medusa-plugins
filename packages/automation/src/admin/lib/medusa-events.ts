...
export const MEDUSA_EVENTS: MedusaEvent[] = [
	...
	// Fulfillment
	{
		...
		payload: [
			{ key: 'id', type: 'string' },
			{ key: 'no_notification', type: 'boolean' }
		]
	},
	{
	...
	},
	{
		...
		label: 'Order Fulfillment Created',
		category: 'Order',
		payload: [
			{ key: 'order_id', type: 'string' },
	...
	},
	{
		...
		label: 'Order Fulfillment Canceled',
		category: 'Order',
		payload: [
			{ key: 'order_id', type: 'string' },
			{ key: 'fulfillment_id', type: 'string' },
	...
	},
	{
		...
		label: 'Order Exchange Created',
		category: 'Order',
		payload: [
			{ key: 'order_id', type: 'string' },
			{ key: 'exchange_id', type: 'string' }
		]
	},
	{
		...
		payload: [
			{ key: 'id', type: 'string' },
			{ key: 'order_change_id', type: 'string' }
		]
	},
	// Payment
	{
	...
	},
	{
		...
		label: 'Product Category Updated',
		category: 'Product Category',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-category.deleted',
		label: 'Product Category Deleted',
		category: 'Product Category',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Product Collection
	{
		...
		label: 'Product Collection Created',
		category: 'Product Collection',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-collection.updated',
		label: 'Product Collection Updated',
		category: 'Product Collection',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-collection.deleted',
		label: 'Product Collection Deleted',
		category: 'Product Collection',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Product Option
	...
	// Product Tag
	{
		...
		label: 'Product Tag Created',
		category: 'Product Tag',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-tag.updated',
		label: 'Product Tag Updated',
		category: 'Product Tag',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-tag.deleted',
		label: 'Product Tag Deleted',
		category: 'Product Tag',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Product Type
	{
		...
		label: 'Product Type Created',
		category: 'Product Type',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-type.updated',
		label: 'Product Type Updated',
		category: 'Product Type',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-type.deleted',
		label: 'Product Type Deleted',
		category: 'Product Type',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Product Variant
	{
		...
		label: 'Product Variant Created',
		category: 'Product Variant',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-variant.updated',
		label: 'Product Variant Updated',
		category: 'Product Variant',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'product-variant.deleted',
		label: 'Product Variant Deleted',
		category: 'Product Variant',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Product
	...
	// Shipping Option Type
	{
		...
		label: 'Shipping Option Type Created',
		category: 'Shipping Option',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'shipping-option-type.updated',
		label: 'Shipping Option Type Updated',
		category: 'Shipping Option',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'shipping-option-type.deleted',
		label: 'Shipping Option Type Deleted',
		category: 'Shipping Option',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Shipping Option
	{
		...
		label: 'Shipping Option Created',
		category: 'Shipping Option',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'shipping-option.updated',
		label: 'Shipping Option Updated',
		category: 'Shipping Option',
		payload: [{ key: 'id', type: 'string' }]
	},
	{
		name: 'shipping-option.deleted',
		label: 'Shipping Option Deleted',
		category: 'Shipping Option',
		payload: [{ key: 'id', type: 'string' }]
	},
	// Translation
