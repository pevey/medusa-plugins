...
type InjectedDependencies = {
  ...
  >
  accessRoleService: ModulesSdkTypes.IMedusaInternalService<
    InferEntityType<typeof AccessRole>
  >
  accessPolicyService: ModulesSdkTypes.IMedusaInternalService<
  ...
  implements IAccessModuleService
{
  ...
  async listAccessRoles(
    ...
    const roles = await super.listAccessRoles(
      filters,
      config as any,
      sharedContext
    )
