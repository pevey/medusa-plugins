...
const base = path.resolve(__dirname, '../../../node_modules/@medusajs/medusa/dist/api/admin')
...
fs.writeFileSync(path.resolve(__dirname, '../src/access-policies/core-route-policies.ts'), header + JSON.stringify(entries, null, 2) + '\n')
