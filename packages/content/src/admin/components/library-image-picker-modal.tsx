		...
		<FocusModal open={open} onOpenChange={onOpenChange}>
			<FocusModal.Content>
				<FocusModal.Header>
					...
					<FocusModal.Description className="sr-only">Choose an image from a content library collection to add.</FocusModal.Description>
				</FocusModal.Header>
							...
							{isLoading ? (
								...
								<div className="flex flex-wrap gap-4 overflow-y-auto">
									{items.map(item => (
										...
										>
											<img src={item.body!} alt={item.title} className="block h-40 w-auto object-contain" />
